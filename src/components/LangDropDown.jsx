        ...
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className={`
                    ...
                    text-xs sm:text-sm sm:gap-3 sm:px-4
                    min-w-[120px] sm:min-w-[140px] overflow-hidden
                    ${dark
            ...
            >
                ...
                {/* Content Layer */}
                <span className="relative z-10 flex items-center justify-center w-4 h-3 sm:w-5 sm:h-3 rounded-sm overflow-hidden">
                    {getFlagIcon(selectedLanguage)}
                </span>
                <span className="relative z-10 font-medium hidden sm:block">
                    <TransText en='Language' fr='Langue' de='Sprache' />
                </span>
                <span className="relative z-10 font-medium block sm:hidden">
                    <TransText en='EN' fr='FR' de='DE' />
                </span>
                <svg
                    className={`relative z-10 w-3 h-3 sm:w-4 sm:h-4 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                >
            ...
            {isOpen && (
                <div
                    className={`
                        absolute bottom-full mb-2 right-0 min-w-[140px] sm:min-w-[160px] rounded-lg
                    ...
                    <div className="p-2">
                        {['de', 'en', 'fr'].map((lang) => (
                            <button
                                ...
                                className={`
                                    w-full flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-1.5 sm:py-2 rounded-md
                                ...
                                `}
                            >
                                <span className="flex items-center justify-center w-4 h-3 sm:w-5 sm:h-3 rounded-sm overflow-hidden">
                                    {getFlagIcon(lang)}
                                </span>
                                <span className={`${dark ? 'text-black' : 'text-white'} font-medium`}>
                                    {getLanguageName(lang)}
                                </span>
                                {selectedLanguage === lang && (
                                    <svg className="w-3 h-3 sm:w-4 sm:h-4 ml-auto text-[#2596be]" fill="currentColor" viewBox="0 0 20 20">
