            ...
            <header>
                <nav className='nav w-[100%] p-[45px]  h-[10vh] flex items-center   justify-center'>
                    <div className="w-[88%] flex items-center justify-between ">
                        <h1 className='text-[35px] font-[briem-extrabold] text-white font-bold hover:text-[#2596be] transition cursor-pointer'>Yahya Codes</h1>
                        <ul className='flex justify-between  w-[50%] font-bold text-white text-[20px] '>
                    ...
                    <label className="switch-name ml-7 mt-[5px]" onClick={()=>{
                        setDark(!dark)
                        console.log(dark);
                    }}>
