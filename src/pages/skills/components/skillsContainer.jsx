    ...
    return (
        <>
            <Element name='skills' className=" flex flex-col items-center justify-center md:gap-14 lg:gap-20 xl:gap-16 gap-12">
                <h1 className={`text-[35px] md:text-[35px] lg:text-[50px] xl:text-[60px] ${dark ? 'text-black' : 'text-white '}  font-[roboto-bold] cursor-pointer hover:text-[#2596be] transition duration-300 `}>
                        ...
                        skills.map((skill) => (
                            <div
                                ...
                                <div style={{ color: skill.color }} className={`card-inner md:p-12 p-12 flex flex-col items-center justify-center`}>
                                    ...
                                    <p className='text-[20px] md:text-[25px] font-[roboto-bold] '>{skill.name}</p></div>
                            </div>
                        ))
                    }
                </div>
