        ...
        <>
            <Element name="about" className=" about-container w-[100%] py-20 md:py-16 flex items-center justify-center md:p-8 p-4 ">
                <div className={`textarea  w-[100%] flex justify-center flex-col gap-10  shadow-xl ${dark ? "text-black" : "text-white"}  rounded-[14px] transition duration-150`}>
                    <h1 className='text-[43px] md:text-[35px] lg:text-[40px] xl:text-[58px] font-[roboto-bold] cursor-pointer text-center hover:text-[#2596be] transition duration-300'>
                        <TransText en='About Me' fr='A Propos De Moi' de='Über Mich' />
                    </h1>
                    <p className='text-[25px] md:text-[24px] backdrop-blur-[1.5px] lg:text-[30px] xl:text-[32px] text-center md:text-start   font-[roboto-regular] w-[100%]'>
                        <TransText
                            en={aboutText.en}
                            fr={aboutText.fr}
                            de={aboutText.de}
