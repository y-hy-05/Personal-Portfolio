                ...
                <span className=' md:w-[40%] w-[100%] flex-col justify-center text-center  md:mt-0 mt-3 md:gap-6   items-center'>
                    ...
                    <div className="md:w-full w-[100%] flex flex-col  justify-center items-center gap-3 md:mt-0 mt-8">
                        ...
                        <span className='flex font-[briem-bold] md:text-[30px] text-nowrap text-[18px] hover:text-[#0077B5] transition duration-300 w-[100%] items-center justify-center md:gap-3 gap-2'>
                            ...
                            <FaLinkedin className='text-[#0077B5] md:text-[16px] text-[30px]' />
                        </span>
                    </div>
                </span>
                <form className={dark?"contactForm md:p-4 bg-[#f0f0f0a0] flex flex-col items-center w-[40%] gap-2 font-[briem-medium] rounded-[20px]":"contactForm md:p-4 bg-[#0000007e] flex flex-col items-center md:w-[40%] w-[100%] gap-2 font-[briem-medium] rounded-[20px]"}>
                    <span className=' flex flex-col gap-[6px] w-[90%]'>
                        ...
                        <input type="text" required name="" id="" className='p-2 rounded-[14px]  text-black' />
                    </span>
                    <span className=' flex flex-col gap-[6px] w-[90%]'>
                        <label htmlFor="" className='text-[22px]  hover:text-[#2596be] transition duration-300  '>Your Email</label>
                        <input type="email" required name="" id="" className='p-2 rounded-[14px] text-black' />
                    </span>
                    <span className=' flex flex-col gap-[6px] w-[90%]'>
                        <label htmlFor="" className='text-[22px]  hover:text-[#2596be]  transition duration-300  '>Your Message</label>
                        <textarea name="" required id="" rows={3} className='p-2 rounded-[14px] text-black' ></textarea>
                    </span>
